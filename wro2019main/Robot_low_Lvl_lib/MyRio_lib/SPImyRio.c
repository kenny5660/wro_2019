 ...
 */
void Spi_Configure(const MyRio_Spi* channel, Spi_ConfigureMask mask,
 ...
 */
void Spi_CounterMaximum(const MyRio_Spi* channel, uint16_t counterMax)
{
    NiFpga_Status status;
 ...
 */
void Spi_Transmit(const MyRio_Spi* channel, uint16_t dataOut, uint16_t* dataIn)
{
    NiFpga_Status status;
    uint8_t spiStatus;
